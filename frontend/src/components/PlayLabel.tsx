...
export function PlayLabel({figure, myName, playerName, isYourTurn, gameOver, onNewGameClick}: FieldSquareProps) {
    return (
        <div
            className="w-full flex flex-col items-center p-4 rounded-xl text-3xl font-bold text-blue-900 bg-gradient-to-r from-orange-200 to-pink-300 select-none">
            ...
            {gameOver !== GameOver.FALSE && <div className="pl-4 pr-4 font-bold text-red-700 animate-pulse">
                {gameOver === GameOver.NOBODY && "NOBODY WIN!!!"}
